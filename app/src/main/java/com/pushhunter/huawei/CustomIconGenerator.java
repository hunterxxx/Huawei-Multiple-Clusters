...
import com.huawei.clustering.IconStyle;
import com.huawei.hms.maps.model.BitmapDescriptor;
import com.huawei.hms.maps.model.BitmapDescriptorFactory;

import static com.huawei.hms.common.Preconditions.checkNotNull;
 ...
 */
public class CustomIconGenerator<T extends ClusterItem> extends DefaultIconGenerator<T> implements IconGenerator<T> {
     ...
     */
    public CustomIconGenerator(@NonNull Context context) {
        super(context);
